        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <x-primary-button class="mt-6">
                    @if (isset($playlist))
                        <a href="{{ route('playlists.edit', $playlist->id) }}">Edit Playlist</a>
                    @else
                        Save Playlist
                    @endif
                </x-primary-button>

                <x-primary-button href="{{ route('playlists.destroy', $playlist->id) }}"
                ...
                <form id="delete-playlist-form" action="{{ route('playlists.destroy', $playlist->id) }}" method="POST" class="hidden">
                    @csrf
                    @method('DELETE')
                </form>
                <br>
